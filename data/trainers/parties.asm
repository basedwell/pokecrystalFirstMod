...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, PERSIAN,    SLASH, BITE, THUNDER, CHARM
	db 32, VILEPLUME,  PETAL_DANCE, TOXIC, SLEEP_POWDER, SLUDGE_BOMB
	db 32, MURKROW,    DRILL_PECK, FAINT_ATTACK, HAZE, NIGHT_SHADE
	db 36, DONPHAN,    EARTHQUAKE, BODY_SLAM, ANCIENTPOWER, ATTRACT
	db 37, OCTILLERY,  OCTAZOOKA, ICE_BEAM, HYPER_BEAM, FLAMETHROWER
	db -1 ; end

	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 23, MEOWTH,     BITE, CUT, PAY_DAY, NO_MOVE
	db 23, GLOOM,      MEGA_DRAIN, TOXIC, SLEEP_POWDER, ACID
