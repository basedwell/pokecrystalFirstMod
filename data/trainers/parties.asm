...
Rival1Group:
	...
	db 20, HAUNTER,    LICK, NIGHT_SHADE, MEAN_LOOK, CURSE
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, GIGA_DRAIN, BITE, CONFUSE_RAY
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 30, GOLBAT,     TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 28, MAGNEMITE,  TOXIC, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 30, HAUNTER,    HYPNOSIS, MEAN_LOOK, CURSE, SHADOW_BALL
