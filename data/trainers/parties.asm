...
PryceGroup:
	...
	db 37, CLOYSTER,   SURF, ICY_WIND, SPIKE_CANNON, SPIKES
	...
	db 34, SNEASEL,    BITE, DIG, ICE_PUNCH, SHADOW_BALL
...
BlaineGroup:
	...
	db 65, RAPIDASH,   SUNNY_DAY, HYPNOSIS, STOMP, FIRE_BLAST
	...
	db 65, ARCANINE,   EXTREMESPEED, FLAMETHROWER, CRUNCH, SUNNY_DAY
...
BlueGroup:
	...
	db 58, ARCANINE,   ROAR, CRUNCH, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
