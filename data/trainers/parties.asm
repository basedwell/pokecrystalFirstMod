...
Rival1Group:
	...
	db 33, MAGMORTAR,  FIRE_PUNCH, THUNDERPUNCH, HEADBUTT, IRON_TAIL
	...
	db 40, MAGMORTAR,  FLAMETHROWER, THUNDERPUNCH, SUNNY_DAY, CONFUSE_RAY
...
Rival2Group:
	...
	db 58, CROBAT,     CURSE, STEEL_WING, FLY, HIDDEN_POWER
	db 57, MAGMORTAR,  SUNNY_DAY, FIRE_BLAST, PYSCHIC_M, THUNDERPUNCH
	...
	db 58, SNEASEL,    SWORDS_DANCE, HIDDEN_POWER, BITE, METAL_CLAW 
	db 58, CROBAT,     CURSE, STEEL_WING, FLY, HIDDEN_POWER
	db 57, ELECTABUZZ, THUNDERBOLT, CURSE, ICE_PUNCH, HYPER_BEAM
