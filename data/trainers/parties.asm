...
Rival1Group:
	...
	; RIVAL1 (8)
	db "?@", TRAINERTYPE_MOVES
	db 20, HAUNTER,    HYPNOSIS, NIGHT_SHADE, MEAN_LOOK, CURSE
	...
	db 32, MAGMORTAR,  FIRE_PUNCH, THUNDERPUNCH, HEADBUTT, IRON_TAIL
	db 32, TEDDIURSA,  FAINT_ATTACK, FURY_CUTTER, FURY_SWIPES, MUD_SLAP
	...
	db 28, MAGNEMITE,  T, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	...
	db 36, GOLBAT,     TOXIC, BITE, CONFUSE_RAY, WING_ATTACK
	db 35, MAGNETON,   THUNDER, SONICBOOM, THUNDER_WAVE, RAIN_DANCE
	db 35, GENGAR,     FIRE_PUNCH, GIGA_DRAIN, SHADOW_BALL, CONFUSE_RAY
	db 35, OCTILLERY
	db 38, MEGANIUM,   REFLECT, GIGA_DRAIN, TOXIC, BODY_SLAM
	db -1 ; end
