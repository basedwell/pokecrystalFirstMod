...
SabrinaGroup:
	...
	db 46, ESPEON,     SUNNY_DAY, MORNING_SUN, BITE, PSYCHIC_M
	db 55, WOBBUFFET,  COUNTER, MIRROR_COAT, DESTINY_BOND, SAFEGUARD
	db 54, GIRAFARIG,  PSYCHIC_M, CRUNCH, AMNESIA, HEADBUTT
	db 56, MEW,        EARTHQUAKE, ANCIENTPOWER, CURSE, REST
	db 46, MR__MIME,   BARRIER, SUBSTITUTE, BATON_PASS, PSYCHIC_M
	db 48, ALAKAZAM,   RECOVER, THUNDER_PUNCH, PSYCHIC_M, ICE_PUNCH
	db -1 ; end
