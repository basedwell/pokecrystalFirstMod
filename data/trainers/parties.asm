...
BlaineGroup:
	...
	db 45, RAPIDASH,   SUNNY_DAY, HYPNOSIS, STOMP, FIRE_BLAST
	db 45, MAGMAR,     THUNDERPUNCH, FLAMETHROWER, SUNNY_DAY, CROSS_CHOP
	db 50, MAGCARGO,   CURSE, BODY_SLAM, EAERTHQUAKE, ROCK_SLIDE
	db 65, ARCANINE,   EXTREMESPEED, FLAMETHROWER, CRUNCH, BODY_SLAM
	db 68, TYPHLOSION, THUNDERPUNCH, FLAMETHROWER, SUNNY_DAY, 
	db 66, CHARIZARD,  BELLY_DRUM, EARTHQUAKE, WING_ATTACK, ROCK_SLIDE
	db -1 ; end
