...
BrockGroup:
	...
	db 67, KABUTOPS,   SLASH, CURSE, ROCK_SLIDE, GIGA_DRAIN
	db 68, AERODACTYL  ROCK_SLIDE, WING_ATTACK, STEEL_WING, EARTHQUAKE
	db 66, GOLEM,      EXPLOSION, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 65, SUDOWOODO,  ROCK_SLIDE, EARTHQUAKE, CURSE, SUNNY_DAY
	db 67, OMASTAR,    BITE, SURF, ICE_BEAM, TOXIC
	db 69, SHUCKLE,    ROLLOUT, TOXIC, REST, WRAP
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 56, POLITOED,   SURF, ICE_BEAM, HYPNOSIS, PERISH_SONG
...
ErikaGroup:
	...
	db 53, BELLOSSOM,  SUNNY_DAY, SYNTHESIS, GIGA_DRAIN, SOLARBEAM
	db 55, SUNFLORA,   PETAL_DANCE, SYNTHESIS, GROWTH, TOXIC
	db 54, MEGANIUM,   SWORDS_DANCE, LIGHT_SCREEN, BODY_SLAM, EARTHQUAKE
	db 55, VENUSAUR,   GROWTH, LEECH_SEED, GIGA_DRAIN, SLEEP_POWDER
	db 51, JUMPLUFF,   SLEEP_POWDER, LEECH_SEED, PROTECT, GIGA_DRAIN
...
JanineGroup:
	...
	db 63, TENTACRUEL, SURF, ICE_BEAM, BARRIER, GIGA_DRAIN
	db 64, CROBAT,     STEEL_WING, TOXIC, CONFUSE_RAY, WING_ATTACK
	db 65, MUK,        ATTRACT, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 65, WEEZING,    PAIN_SPLIT, FIRE_BLAST, TOXIC, EXPLOSION
	db 67, ARIADOS,    TOXIC, SLUDGE_BOMB, DIG, NIGHT_SHADE
	db 64, NIDOQUEEN,  BODY_SLAM, SURF, EARTHQUAKE, BITE
	db -1 ; end
...
SabrinaGroup:
	...
	db 56, ESPEON,     SUNNY_DAY, MORNING_SUN, BITE, PSYCHIC_M
...
BlaineGroup:
	...
	db 65, RAPIDASH,   SUNNY_DAY, HYPNOSIS, HIDDEN_POWER, FIRE_BLAST
	db 68, CHARIZARD,  BELLY_DRUM, EARTHQUAKE, WING_ATTACK, ROCK_SLIDE
	db 67, MAGMAR,     THUNDERPUNCH, FLAMETHROWER, SUNNY_DAY, CROSS_CHOP
	db 63, MAGCARGO,   CURSE, BODY_SLAM, EARTHQUAKE, ROCK_SLIDE
	db 65, ARCANINE,   EXTREMESPEED, FLAMETHROWER, CRUNCH, HIDDEN_POWER
	db 66, TYPHLOSION, THUNDERPUNCH, FLAMETHROWER, SUNNY_DAY, IRON_TAIL
	db -1 ; end
...
BlueGroup:
	...
	db 56, PIDGEOT,    DOUBLE_EDGE, TOXIC, WING_ATTACK, MIRROR_MOVE
	db 54, ALAKAZAM,   THUNDER_PUNCH, RECOVER, PSYCHIC_M, REFLECT
	db 56, RHYDON,     DYNAMIC_PUNCH, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 58, GYARADOS,   BITE, WING_ATTACK, EARTHQUAKE, ROCK_SLIDE
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, PSYCHIC_M, SOLARBEAM
	db 58, ARCANINE,   IRON_TAIL, CRUNCH, CURSE, EXTREMESPEED
	db -1 ; end
