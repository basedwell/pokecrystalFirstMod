	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, TOXIC, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, RAIN_DANCE, ENDURE, FRUSTRATION, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, DETECT, REST, ATTRACT, ICE_BEAM, FLAMETHROWER, THUNDER, FIRE_BLAST, BODY_SLAM, ROCK_SLIDE, THUNDER_WAVE, SUBSTITUTE, COUNTER, THUNDERBOLT
	; end
